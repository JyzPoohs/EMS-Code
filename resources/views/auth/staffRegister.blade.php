            ...
            <div class="card" style="background-color: #f7ecda">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="department" class="col-md-4 col-form-label text-md-end">{{ __('Access Category') }}</label>
                            <div class="col-md-6 form-group">
                                    <select class="form-select">
                        ...
                        <div class="row mb-3">
                            <label for="department" class="col-md-4 col-form-label text-md-end">{{ __('Position') }}</label>
                            <div class="col-md-6 form-group">
                                    <select class="form-select">
                        ...
                        <div class="row mb-3">
                            <label for="department" class="col-md-4 col-form-label text-md-end">{{ __('PAID') }}</label>
                            <div class="col-md-6 form-group">
                                    <select class="form-select">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-5">
                                <button type="submit" class="btn btn-primary" id="registerBtn" style="background-color: #9b1233; border:none;">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
